...
class VoiceNoteViewModel : NSObject, ObservableObject , AVAudioPlayerDelegate{
    ...
    @Published var recordingsList = [VoiceNote]()
    
    @Published var countSec = 0
    @Published var timerCount : Timer?
    @Published var blinkingCount : Timer?
    @Published var timer : String = "0:0:00"
...
//            if recordingsList[i].noteText == playingURL {
...
//    }
    ...
    func startRecording() {
        ...
        let fileName = path.appendingPathComponent("cobacoba : \(Date().toString(dateFormat: "dd-MM-YY 'at' HH:mm:ss")).m4a")
...
//            recordingsList.append(VoiceNote(noteText : i, noteDate:getFileDate(for: i), noteTitle: i))
//        }
//
